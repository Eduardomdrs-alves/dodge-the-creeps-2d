...
func _on_chaser_enemy_timer_timeout() -> void:
	var chaser = chaser_enemy_scene.instantiate()
	add_child(chaser)
...
func _on_power_up_timer_timeout() -> void:
	...
	add_child(powerup) # Replace with function body.
